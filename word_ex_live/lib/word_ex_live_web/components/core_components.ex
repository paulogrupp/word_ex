defmodule WordExLiveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(WordExLiveWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(WordExLiveWeb.Gettext, "errors", msg, opts)
    # end
